...
| 12   | F-023 | `feat(F-023): remove compose location` | 3.18.0      | 123           | 移除写微博「位置」：无定位权限；删 `ComposeLocationHelper`；`insertPostWithPreparedGallery` 不再写 `extrasJson.location`；\@ 与 `extrasJson` 列保留。 |
