...
| F-019 | **提醒 / 闹钟**：为单条微博或时间点设置 **本地通知**（`AlarmManager.setAlarmClock` + `Notification`）；详情 ⋮ **多久后提醒** 含 **15 分钟**快捷项，其余以 **30 分钟为一档**、最长 **24 小时**；**Android 13+** 需 **通知运行时权限** 才会弹出提醒；渠道 **高重要性** + 专用状态栏图标；**不依赖外网**。 | Done |
